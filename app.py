...
st.divider()
st.caption('THIS IS JUST AN EDUCATIONAL PROJECT')
st.caption('This project utilizes the PaLM API to provide information')
st.caption('Please note that the results generated by the API may be inaccurate or incomplete') 
st.caption('The information presented should not be considered as absolute or authoritative, and it is advised to verify any critical details through reliable sources')
st.divider()
